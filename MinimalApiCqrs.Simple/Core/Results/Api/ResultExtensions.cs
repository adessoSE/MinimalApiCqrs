...
public static class ResultExtensions
{
    ...
    public static TypedApplicationResult<TSuccessResult> ToTypedApiResult<TSuccessResult>(
        this Result result,
        Func<TSuccessResult> successResultMap
    )
    ...
    public static TypedApplicationResult<Ok<TResult>> ToTypedApiResult<TResult>(
    ...
    public static TypedApplicationResult<TSuccessResult> ToTypedApiResult<TResult, TSuccessResult>(
        this Result<TResult> result,
        Func<TResult, TSuccessResult> successResultMap
    )
        where TSuccessResult : IResult
        where TResult : notnull
    {
